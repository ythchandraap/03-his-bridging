...
export const ProcessCashierReceiptDto = async (
  ...
  await connection.query(
    `
      ...
      UPDATE
        t_receipt_id=
      VALUES (t_receipt_id), t_receipt_type=
      VALUES (t_receipt_type), t_paid_off_date=
      VALUES (t_paid_off_date), t_receipt_status=
      VALUES (t_receipt_status), created_date=
      VALUES (created_date), updated_date=
      VALUES (updated_date), created_by=
